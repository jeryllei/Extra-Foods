package com.dyrnwyn.extrafoods.util;

import com.dyrnwyn.extrafoods.ExtraFoods;
import com.dyrnwyn.extrafoods.items.*;
...
public class RegistryHandler {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, ExtraFoods.MOD_ID);
